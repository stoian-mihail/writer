...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/delete-post-photo', [App\Http\Controllers\PostController::class, 'destroyPhoto'])->name('admin.posts.delete.photo');
    ...
    Route::post('/delete-news-photo', [App\Http\Controllers\NewsController::class, 'destroyPhoto'])->name('admin.news.delete.photo');
