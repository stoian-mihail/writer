            ...
            <div class="mt-5">
                ...
                <article>
                    <div class="row mt-2 text-left">
                        <div class="col-2 p-0">
                            <img src="{{$post->photos()->first()? $post->photos()->first()->thumbnail->file_url:''}}" alt="post image" class="img-fluid">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-4">
                            <div class="row">
                                <a type="button" class="btn btn-primary" href="{{route('admin.products.edit', ['product'=>$post])}}">Editeaza</a>
                             </div>
                            <div class="row mt-2">
                                <form action="{{route('admin.products.delete',$post->id)}}" class="delete_form" method="post"
