            ...
            <div class="mt-5">
                ...
                <article>
                    <div class="row mt-2 text-left">
                        ...
                        <div class="col-4">
                            <div class="row">
                                <a type="button" class="btn btn-primary" href="{{route('admin.posts.edit', ['post'=>$post])}}">Editeaza</a>
                             </div>
                            <div class="row mt-2">
                                <form action="{{route('admin.posts.delete',$post->id)}}" class="delete_form" method="post"
